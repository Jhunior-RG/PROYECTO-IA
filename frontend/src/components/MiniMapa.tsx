                ...
                {occupied ? (
                  <ul className="space-y-3 max-h-48 overflow-y-auto pr-2">
                    {lugar.asistencias.map((asistencia) => (
                      ...
                      >
                        <div className="flex w-10 h-10 rounded-full bg-gray-200 overflow-hidden items-center justify-center mr-3">
                          {asistencia.usuario?.perfil === null ? (
                            <FaUser className="text-teal-600" />
                          ) : (
                            <img
                              src={asistencia.usuario?.perfil}
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">
                            Entrada: {formatTime(asistencia.hora_entrada)}
                          </p>
                        </div>
                      </li>
                    ))}
